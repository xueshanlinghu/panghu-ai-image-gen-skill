...
- 📚 **内置提示词模板库**：自带人像/海报/角色/UI/创意场景等5大类30+高质量提示词模板，不会写描述直接让AI调用模板自动调整，不用自己想提示词
...
AI会自动和你确认需求、推荐合适的参数，如果你不知道怎么写描述，直接说想要什么场景，AI会自动从内置模板库挑选合适的提示词帮你调整，生成完成后直接给你图片链接和本地保存路径，不需要你敲任何命令。
...
## 💡 注意事项
1. 4K高清图片生成约需1-5分钟，请耐心等待，**不要中途中断请求**，避免重复消耗积分
